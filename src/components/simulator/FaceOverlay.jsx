 ...
 */
const FaceOverlay = ({ facePhase, glowSide }) => {
  ...
  return (
    <>
      ...
      {isPhase2 && (
        <div
          ...
          style={{
            ...
            background: 'radial-gradient(ellipse at left center, rgba(225,50,127,0.35) 0%, transparent 70%)',
          }}
        />
      )}
      {/* Left face */}
      <div
        ...
        style={{ zIndex: 1 }}
      >
        {isPhase2 ? <Phase2Left /> : <Phase1Left />}
      </div>
      ...
      {isPhase2 && (
        <div
          ...
          style={{
            ...
            background: 'radial-gradient(ellipse at right center, rgba(109,105,135,0.45) 0%, transparent 70%)',
          }}
        />
      )}
      {/* Right face */}
      <div
        ...
        style={{ zIndex: 1 }}
      >
        {isPhase2 ? <Phase2Right /> : <Phase1Right />}
      </div>
    </>
  );
};

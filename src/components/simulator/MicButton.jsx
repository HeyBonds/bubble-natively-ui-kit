      ...
      >
        ...
        <svg
          ...
          style={{
            ...
            filter: isWaiting ? sim.micWaitingGlow : 'none',
            animation: isWaiting ? 'borderPulse 1.5s ease-in-out infinite' : 'none',
          }}
        >
          <rect x="0.5" y="0.5" width="59" height="69" rx="29.5" stroke={sim.micIcon} />
          <path
        ...
        >
          <rect x="0.5" y="0.5" width="59" height="69" rx="29.5" fill={sim.micRecordingBg} />
          <rect x="0.5" y="0.5" width="59" height="69" rx="29.5" stroke={sim.micIcon} />
